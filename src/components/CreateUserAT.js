...
export default function CreateUserAT() {
  ...
  return (
    <UserPanel>
      <div className="register self-center  flex flex-col mx-5 justify-center items-center text-white">
        <h2 className="mb-7 text-3xl md:text-2xl xl:text-3xl lg:text-3xl sm:text-3xl text-center">
          Faça o cadastro do seu Auditor Técnico. Ele recebera um email com as
          credenciais de acesso, para poder começar a gerenciar projetos
        </h2>
        <form className="w-full max-w-lg self-center " onSubmit={handleSubmit}>
          ...
          {response.status === 1 && (
            <div className="response bg-green-500 flex justify-center text-lg">
              {response.message}
              <br />
              {"Auditor Técnico criado com sucesso."}
              <br />
              {"Aguarde..."}
            </div>
          )}
